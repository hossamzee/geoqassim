...
<div class="jumbotron">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                @if ($random_photo)
                  <a href="{{ route('photos_show', [$random_photo->album_id, $random_photo->id]) }}"><img src="{{ $random_photo->thumb_url }}" class="img-responsive img-featured img-grayscale" /></a>
                @endif
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <p>نشرة «الرمة» تصدر عن قسم الجغرافيا بجامعة القصيم، وهي وريقات جغرافية متواضعة، تعكس صورة ما جرى من قبل، وما يجري حالياً في فلك الجغرافيين في القسم من أنشطة علمية، وأخبار جغرافية، ومخرجات معرفية، ورحلات ميدانية، نستهدف بها، ونأمل منها مد جسر التوصل مع الأقسام والكليات والعمادات بجامعة القصيم أولاً، والجامعات الأخرى ثانياً، وعموم المتابعين ثالثاً، وتجدر الإشارة إلى أن مشاركات الزملاء تم اختصارها واختزالها بصورة نرجو ألا تكون مخلة، بسبب ضيق المساحة. مع تحيّات الرمّة.</p>
            <p>
                @if ($last_rummah)
