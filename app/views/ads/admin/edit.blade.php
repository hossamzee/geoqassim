...
@section('title', 'تعديل إعلان - '. $ad->title)
@section('content')
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            {{ Form::open(['route' => ['admin_ads_update', $ad->id]]) }}
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {{ Form::textarea('content', $ad->content, ['class' => 'form-control', 'id' => 'content']) }}
                        </div>
                    </div>
                    <div class="col-md-12 text-right">
                        {{ Form::submit('تعديل الإعلان', ['class' => 'btn btn-primary btn-lg']) }}
                    </div>
                </div>
            {{ Form::close() }}
        </div>
