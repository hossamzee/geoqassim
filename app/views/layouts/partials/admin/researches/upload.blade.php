...
<script type="text/javascript">
    ...
    function beforeSubmit()
    {
        ...
        $('#upload-status-div').html('تجري محاولة رفع البحث و الدراسة إلى الخادم...');
    ...
    function afterError(response)
    {
        ...
        $('#upload-status-div').html('<div>لا يمكن رفع البحث و الدراسة ، إمّا لخطأ في الإدخال أو لخطأ في الخادم.</div><br /><div><a class="btn btn-default" href="#" onclick="resetUpload()">رفع بحث و دراسة أخرى</a></div>');
    }
...
<div class="row well">
    <div class="col-md-12" id="upload-div">
        {{ Form::open(['route' => 'admin_researches_upload', 'files' => true, 'id' => 'upload-form']) }}
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        {{ Form::label('title', 'ملف PDF (اختياري)') }}
                        {{ Form::file('pdf') }}
                        <p class="help-block">في حال لم يتم رفع البحث و الدراسة إلى أيّ خادم آخر؛ قم برفع الملف من هنا.</p>
                    </div>
                </div>
